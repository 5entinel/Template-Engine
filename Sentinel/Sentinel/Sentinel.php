<?php
    ...
    /**
    ** @Project: Personal Template Engine
    ** @Version: 0.1
    ** @Developer: Sentinel
    ** @Function: My own PHP Template engine
    **/

    namespace Sentinel;

    use Sentinel\Exception\{ Build as BuildException, Config as ConfigException };
    ...
    class Sentinel
    {
        ...
        */
        ...
        /**
        * Constructor
        * @param {array} $config Sentinel configuration
        **/
        public function __construct(array $config) {
            ...
            if(!$this->_dir)
                throw new ConfigException('Sentinel build directory not specified');
        ...
        /**
        * Assign new variable to Sentinel
        ...
        **/
        ...
        /**
        * Build & Interprete Sentinel from file
        ...
        **/
        ...
        /**
        * Build & Interprete Sentinel from string
        ...
        **/
        ...
        /**
        * Interpret Sentinel components, Parse Sentinel modules
        * @param {string} $fileData Sentinel file data
        **/
        ...
        */
        ...
        /**
        * Parse Sentinel's array statements
        * @param {string} $fileData Sentinel file data
        ...
        **/
        ...
        /**
        * Runs Sentinel mini calculations
        * @param {string} $fileData Sentinel file data
        **/
        ...
        /**
        * Parse Sentinel's comment statement
        **/
        ...
        /**
        * Parse Sentinel's conditional statements
        * @param {string} $fileData Sentinel file data
        **/
        ...
        /**
        * Parse Sentinel's each statement
        * @param {string} $fileData Sentinel file data
        **/
        ...
        /**
        * Parse Sentinel variable filters
        * @param {string} $fileData Sentinel filedata
        **/
        ...
        * @param {string} $fileData Sentinel file data to parse
        **/
        ...
        **/
        ...
        /**
        * Runs Sentinel array compilation
        * @param {string} $arrayData Sentinel array string
        **/
        ...
        **/
        ...
        /**
        * Compile Sentinel condtion statement to full bind-able sent
        ...
        */
        ...
        /**
        * Get local file link
        * @param {string} $filename Sentinel filename without extension
        **/
        ...
        /**
        * Get value of Sentinel variable
        ...
        **/
        ...
        /**
        * Strip Sentinel binder
        * @param {string} $str Sentinel file data
        **/
